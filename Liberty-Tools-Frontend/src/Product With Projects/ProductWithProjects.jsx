      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        {products && products.map((item, idx) => (
          <div
            ...
            data-aos="zoom-in-up"
            data-aos-duration="1500"
            className="relative group rounded-xl border-2 border-yellow-300 overflow-hidden aspect-[4/3] cursor-pointer"
          >
            {/* Background image */}
            <div
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center opacity-0 group-hover:opacity-100 transition duration-300 z-10">
              <div className="flex gap-4 mb-4">
                ...
                <button className="bg-opacity-80 rounded-full p-3 cursor-pointer shadow bg-yellow-400 transition">
            ...
            {(
              <span className="absolute top-3 left-3 bg-yellow-600 text-white px-3 py-1 rounded font-semibold text-sm z-20">
