...
export const DashboardCertificate = () => {
    ...
    return (
        <div className='md:mx-4 my-2 space-y-3 w-full px-5 '>
            <label htmlFor="certificate" className='btn text-base font-semibold hover:bg-orange-400 bg-orange-500 rounded-md text-white  '>
                    ...
                    certificate && certificate.map((item, index) => {
                        return (
                            <div className='relative group' key={index}>
                                <div className="card cursor-pointer relative bg-base-100 border-orange-500 rounded-md shadow-sm">
                                    <figure>
                                        <ModalImage
