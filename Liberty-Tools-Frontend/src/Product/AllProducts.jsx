...
import banner from "../assets/img/warehouse.jpg"
export const AllProducts = () => {
    ...
    return (
        <section>
            <div className=' overflow-hidden -mt-20  bg-amber-700 lg:h-[500px]'>
                <img loading="lazy" src={banner || ``} className='  md:w-full max-sm:h-[300px]  brightness-50' alt="" />
            </div>
            <div className={`max-w-[1340px] ${!location.pathname.startsWith('/dashboard') && 'mx-auto'}  space-y-5 bg- mb-20`}>
            




                <div className='w-full h-[50px] bg-yellow-400 rounded-lg flex items-center justify-center md:my-5 my-5'>
