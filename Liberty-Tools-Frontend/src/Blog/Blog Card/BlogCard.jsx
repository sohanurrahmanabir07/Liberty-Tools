...
export const BlogCard = ({ post }) => {
    ...
    return (
        <div className="px-2 relative group  "  data-aos="zoom-in-up"   data-aos-duration="1500"> 
                    ...
                    <div className='absolute md:group-hover:opacity-100 md:opacity-0 opacity-100 space-x-2 transition-all duration-150 ease-in-out right-2 top-2'>

                        {
                            !post ?
                                ...
                                :
                                (
                                    <label htmlFor={`ProductUpdate-${post?._id}`} className='btn btn-primary btn-dash px-2 rounded-sm'>Update</label>
                                )
